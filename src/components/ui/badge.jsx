  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        opus: "border-transparent bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300",
        sonnet: "border-transparent bg-cyan-100 text-cyan-700 dark:bg-cyan-900 dark:text-cyan-300",
