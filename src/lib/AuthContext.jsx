...
export function AuthProvider({ children }) {
  ...
  const value = {
    ...
    isPro: profile?.tier === 'pro' || profile?.tier === 'basic' || FOUNDER_EMAILS.includes(clerkUser?.primaryEmailAddress?.emailAddress),
    tier: FOUNDER_EMAILS.includes(clerkUser?.primaryEmailAddress?.emailAddress) ? 'pro' : (profile?.tier || 'free'),
    signOut,
    supabaseClient,
    getToken,
