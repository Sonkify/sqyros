        ...
        <Card className="w-full max-w-md border-0 shadow-2xl">
          ...
          <CardContent className="text-center">
            <p className="text-sm text-muted-foreground mb-6">
              Click the link in the email to verify your account and get started with Sqyros.
            </p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-700 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200 mt-2">AV Setup & Maintenance Assistant</p>
        </div>
        ...
        <Card className="border-0 shadow-2xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Get started with 3 free integration guides
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center text-white">
          <div>
            ...
            <div className="text-sm text-blue-200">AV Devices</div>
          </div>
          <div>
            <div className="text-2xl font-bold">10+</div>
            <div className="text-sm text-blue-200">Core Systems</div>
          </div>
          <div>
